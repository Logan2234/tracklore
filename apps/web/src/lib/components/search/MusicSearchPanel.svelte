<script lang="ts">
  ...
  import type { MusicEntryDto, MusicSummaryDto } from "@tracklore/shared";
...
{:else if results.length > 0}
  <PosterGrid>
    {#each results as album (album.sourceId)}
...
{:else}
  <EmptyState>Lance une recherche pour trouver un album à ajouter.</EmptyState>
{/if}
