	...
	const days: Day[] = [
		{
			...
			date: 'lun. 2 juil.',
			slots: [
				{ title: 'Severance', code: 'S02E05', epTitle: 'Trojan’s Horse', time: '21:00' },
		...
		},
		{
			label: 'Demain',
			date: 'mar. 3 juil.',
			slots: [{ title: 'Shōgun', code: 'S01E05', epTitle: 'Broken to the Fist', time: '—' }]
		},
		{
			label: 'Mercredi',
			date: 'mer. 4 juil.',
			slots: [{ title: 'Frieren', code: 'S01E29', epTitle: 'Aussi ordinaire que possible', time: '18:30' }]
		},
		{
			label: 'Vendredi',
			date: 'ven. 6 juil.',
			slots: [
				{ title: 'The Boys', code: 'S04E07', epTitle: 'Season Finale', time: '—' },
				{ title: 'Dan Da Dan', code: 'S01E02', epTitle: 'Un ennemi arrive', time: '17:00' }
			]
		}
	];
</script>
...
<div class="mx-auto max-w-4xl px-4 py-6 md:px-8 md:py-10">
	<header class="mb-8">
		<div class="flex items-baseline gap-3">
			<h1 class="font-display text-3xl font-extrabold tracking-tight md:text-4xl">Calendrier</h1>
			<span class="rounded-full bg-surface-2 px-2.5 py-0.5 text-xs font-semibold text-dim">Aperçu</span>
		</div>
		<p class="mt-1 text-dim">
			Les prochains épisodes de ce que tu suis. Données de démonstration — elles se brancheront sur
			les dates de diffusion réelles.
		</p>
	</header>
