...
export class LibraryController {
  ...
  @Delete('entries/:id')
  async deleteEntry(@CurrentUser() user: JwtPayload, @Param('id') entryId: string): Promise<void> {
  ...
  @HttpCode(HttpStatus.NO_CONTENT)
  @Delete('watches/:id')
  async deleteWatch(@CurrentUser() user: JwtPayload, @Param('id') watchId: string): Promise<void> {
